...
const DisplayPage: React.FC = () => {
    ...
    if (miniGame.gameType === 'RED_ENVELOPE' && miniGame.phase === 'IDLE') {
        return (
            <div
                style={{
                    height: '100vh',
                    ...
                    alignItems: 'center',
                    justifyContent: 'center',
                    backgroundImage: `linear-gradient(135deg, rgba(31,11,11,0.7) 0%, rgba(10,3,3,0.7) 100%), url('/background/idle.webp')`,
                    backgroundSize: 'cover',
                    backgroundRepeat: 'no-repeat',
                    backgroundPosition: 'center',
                    color: '#fff',
            ...
            >
                <div style={{ fontSize: 48, fontWeight: 800, marginBottom: 16 }}>🧨 準備搶紅包</div>
                <div style={{ fontSize: 24, opacity: 0.9 }}>等待主持人開始...</div>
            </div>
        );
    }
